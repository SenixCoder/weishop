...
class WeixinAddonModel extends WeixinModel{
	public function reply($dataArr, $keywordArr = array()) {
        ...
        $this->replyText('http:/www.szjlxh.com/weiphp/Addons/Weishop/shop/index.php?route=account/registerbywx&openid='.$map['openid'].'&username='.base64_encode($this->getUserInfo()));
    }
